...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/SummerSoftTeam/AliPaySDK.git", :tag => "15.1.3" }
  ...
  s.frameworks = "UIKit", "CFNetwork", "CoreGraphics", "SystemConfiguration", "Foundation", "CoreMotion", "QuartzCore", "CoreText", "CoreTelephony"
